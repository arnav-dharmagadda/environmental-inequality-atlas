...
#labs(title = "Total Population by Race/Ethnicity in Charlottesville and Albemarle County (1999)",
#x = "Race/Ethnicity",
...
ggplot(race_totals, aes(x = reorder(race, -share), y = share)) +
  ...
  labs(
    title = "Population Share by Race/Ethnicity in Charlottesville and Albemarle County (1999)",
    x = "Race/Ethnicity",
