...
\lato\scriptsize\textit{Notes}: Map with hexagonal grid shows PM2.5 concentrations.
...
```
\lato\textcolor{black}{\large\textbf{Average PM2.5 Exposure and Exceeding Standard Rate by Race/Ethnicity}}
...
\lato\scriptsize\textit{Notes}: By race/ethnicity, this table shows the local and national average PM2.5 exposure in 2023 and local trend 2000-2023. Additionally, it shows local and national rate of people living in areas exceeding the national standard in 2023 and local trend 2000-2023.
...
```
\lato\textcolor{black}{\large\textbf{Average PM2.5 Exposure and Exceeding Standard Rate by Income Decile}}
...
\lato \scriptsize \textit{Notes:} By income decile, this table shows the local and national average PM2.5 exposure in 2023 and local trend 2000-2023. Additionally, it shows local and national rate of people living in areas exceeding the national standard in 2023 and local trend 2000-2023.
...
\lato \scriptsize \textit{Notes:} Each line represents a different racial group. For each income decile, the average PM2.5 exposure is shown. 
